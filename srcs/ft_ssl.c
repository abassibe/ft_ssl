...
void readAndInitialize(t_ssl *ssl, char **av)
{
	char *str;
	char *buffer;
	int fd;
...
void initConstant(t_ssl *ssl)
{
	uint32_t r[64] = {7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17,
...
void fillStructPattern(t_ssl *ssl)
{
